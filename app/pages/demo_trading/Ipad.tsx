                ...
                <div className="dc-w-490 dc-h-456 dc-flex dc-gap-12">
                    ...
                    <div className="dc-w-245 dc-h-456 dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-border dc-border-[#1F2126] dc-rounded-[20px] dc-p-5">
                        ...
                        <div className="dc-h-24 dc-flex dc-w-full dc-items-center dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-border dc-border-white dc-border-opacity-6 dc-rounded-[8px] dc-mb-6">
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-16 ${calculatedPercentage === 10 ? "dc-text-white dc-font-bold dc-bg-[#FDB41D] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(10)}
                            >
                                10%
                            </button>
                            <button
                                className={`dc-w-1/5 dc-h-16 dc-flex dc-items-center dc-justify-center dc-text-10 ${calculatedPercentage === 25 ? "dc-text-white dc-font-bold dc-bg-[#FDB41D] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(25)}
                            >
                                25%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-16 ${calculatedPercentage === 50 ? "dc-text-white dc-font-bold dc-bg-[#FDB41D] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(50)}
                            >
                                50%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-16 ${calculatedPercentage === 75 ? "dc-text-white dc-font-bold dc-bg-[#FDB41D] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(75)}
                            >
                                75%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-16 ${calculatedPercentage === 100 ? "dc-text-white dc-font-bold dc-bg-[#FDB41D] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                ...
                <div className="dc-min-h-300 dc-p-2">
                    ...
                    <div className="dc-h-36 dc-flex dc-items-center dc-justify-between dc-mb-2">
                        <div className="dc-p-4 dc-flex dc-items-center dc-justify-between dc-bg-gradient-to-br dc-from-[#131416] dc-to-[#0A0A0B] dc-border dc-border-white dc-border-opacity-6 dc-rounded-[12px]">
                            <button
                                className={`dc-px-12 dc-h-24 dc-text-11 ${activeOrderTab === "Position" ? "dc-text-white dc-bg-[#FDB41D] dc-rounded-[10px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Position")}
                            >
                                {t('trading.position')}({positions.length})
                            </button>
                            <button
                                className={`dc-px-12 dc-h-24 dc-text-11 ${activeOrderTab === "Current Orders" ? "dc-text-white dc-bg-[#FDB41D] dc-rounded-[10px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Current Orders")}
                            >
                                {t('trading.currentOrders')}({orders.filter(order => order.status === "PENDING").length})
                            </button>
                            <button
                                className={`dc-px-12 dc-h-24 dc-text-11 ${activeOrderTab === "Order History" ? "dc-text-white dc-bg-[#FDB41D] dc-rounded-[10px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Order History")}
                            >
                                {t('trading.orderHistory')}
                            </button>
                            <button
                                className={`dc-px-12 dc-h-24 dc-text-11 ${activeOrderTab === "PnL" ? "dc-text-white dc-bg-[#FDB41D] dc-rounded-[10px]" : "dc-text-white"}`}
